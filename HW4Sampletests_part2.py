...
class HW4_part2_SampleTests(unittest.TestCase):
    ...
    def test_user1(self):
        userPythogoreanTheoremTest = """
                    ...
                    """
        opstackOutput = [True]
        interpreter(userPythogoreanTheoremTest)
        self.assertEqual(opstack,opstackOutput)
    ...
    def test_user2(self):
        ...
        cleartomark
        """
        opstackOutput = ["/x",3,"/y", 5, "-mark-", 5, 5]
        interpreter(userTestInput)
        self.assertEqual(opstack,opstackOutput)
    ...
    def test_user4(self):
        userTestInput = """
                        /x 5 def 15 dup count mul x
                        """
        opstackOutput = [15,30,5]
        interpreter(userTestInput)
        self.assertEqual(opstack,opstackOutput)
    def test_user5(self):
        userTestInput = """
                        /x 5 def 15 clear x 60
                        """
        opstackOutput = [5, 60]
        interpreter(userTestInput)
        self.assertEqual(opstack,opstackOutput)
